    ...
    <form>
      ...
      <div class="col-xs-12">
        <div class="col-xs-6 middle">
          ...
          <div class="col-xs-7">
            <select id="subarea" class="form-control" disabled>
      ...
      <div class="col-xs-12">
        ...
        <div class="col-xs-6 middle">
          ...
          <div class="col-xs-7">
            <select id="empleado" class="form-control" disabled>
      ...
      <div class="col-xs-12 middle">
        <div class="col-xs-3">
         ...
         <div class="col-xs-3">
          <div class="radio radio-primary">
            <label>
              <input type="radio" name="mantenimiento" class="mantenimiento" value="Programado" disabled>
              Programado
            </label>
          </div>
        </div>
        <div class="col-xs-3">
          <div class="radio radio-primary">
            <label>
              <input type="radio" name="mantenimiento" class="mantenimiento" value="Preventivo" disabled>
              Preventivo
            </label>
          </div>
        </div>
      ...
      <div class="col-xs-12">
        <textarea id="detalle" rows="4" class="form-control" disabled></textarea>
      </div>
      ...
      <div class="col-xs-12">
        <textarea id="observacion" rows="4" class="form-control" placeholder="Escriba su observacion"></textarea>
      </div>
      <div class="col-xs-6 col-xs-offset-5" style="display:none">
        <input type="file" id="diagnostico" accept="application/pdf">
      ...
      <div class="col-xs-12 center">
        ...
        <button class="btn btn-raised btn-default" id="ordenFormAceptar">Ingresar Herramientas y Repuestos</button>
        <button class="btn btn-raised btn-info" id="ordenFormSave" style='display:none'>Terminar</button>
        <button class="btn btn-raised btn-warning" id="meOlvideMat" style='display:none'>Se me olvido materiales</button>
      </div>
    </form>
  </div>
</div>
...
<div class="panel panel-success panel-tiempos">
  ...
  <div class="panel-body">
    <div class="col-xs-12 space-around middle">
      ...
      <button class="btn btn-raised btn-default" id="ordenFormTimeInicio">Ingresar tiempos</button>      
    </div>
