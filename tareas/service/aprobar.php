...
$update = $pdo->query("UPDATE sgmetare SET etare_est_etare='aprobado' WHERE etare_cod_etare='$id'");

$pdo->query("DELETE FROM sgmerepta WHERE repta_cod_repta='$id'");
$pdo->query("DELETE FROM sgmeherta WHERE herta_cod_herta='$id'");
