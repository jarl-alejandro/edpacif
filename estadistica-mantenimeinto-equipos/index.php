...
<html lang="es">
<head>
  <title>Estadistica de mantenimiento de equipos | EdPacif</title>
      ...
      <div class="contentpanel">
        <div class="row">
          <div class="col-md-9 col-lg-8 dash-left">
            <h2 class="text-center no-margin title">Estadistica de mantenimiento de equipos</h2>
            ...
            <!-- /panel-->
              ...
              <div class="panel panel-success" id="estadistica-form">
                <div class="panel-heading">
                  <h3 class="panel-title text-center">Estadistica de mantenimiento</h3>
                </div>
