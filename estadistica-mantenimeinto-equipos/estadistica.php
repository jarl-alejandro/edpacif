...
Highcharts.chart('container', {
    ...
    series: [{
        ...
        while($equipo = $equipos->fetch()) {
          $index++;
          $mesStart = date("n", strtotime($equipo["eorin_fet_eorin"])) - 1;
          $dayStart = date("d", strtotime($equipo["eorin_fet_eorin"]));
          $dayNameStart = date("N", strtotime($equipo["eorin_fet_eorin"])) - 1;
          $yearStart = date("y", strtotime($equipo["eorin_fet_eorin"]));
