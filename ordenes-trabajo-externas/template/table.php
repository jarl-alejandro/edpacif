  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="space-around middle">
         <?php if($rows["eorex_est_eorex"] == "envio"){ ?>
          <button class="btn btn-raised center button__little enviadoExterna btn-warning"
            data-id="<?= $rows["eorex_cod_eorex"]; ?>">
            <img src="../assets/iconos/reparacion.png" width='31px'>            
          </button>
        <?php } else if($rows["eorex_est_eorex"] == "terminar"){ ?>
