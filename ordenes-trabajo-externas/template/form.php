...
<div class="panel panel-info">
  <div class="panel-heading">
    <h3 class="panel-title text-center">Nueva orden de trabajo</h3>
  </div>
  <div class="panel-body">
    <form>
      <input type="text" id="facturaExternaInput" style="display:none;" />
      <input type="text" id="InformExternaInput" style="display:none;" />
      ...
      <div class="col-xs-12">
        <div class="col-xs-6 middle">
          ...
          <div class="col-xs-7">
            <input id="trabajo" class="form-control" disabled value="EXTERNA"/>
          </div>
        </div>

        <div class="col-xs-6 middle">
          <label for="proveedor" class="col-xs-3 control-label">Proveedor</label>
          <div class="col-xs-7">
            <select id="proveedor" class="form-control">
              <option value="">Selecione el proveedor</option>
              <?php
                $proveedor = $pdo->query("SELECT * FROM sgmepro");
                while($row = $proveedor->fetch()){
              ?>
              <option value="<?= $row["eprov_cod_eprov"] ?>">
                <?= $row["eprov_nom_eprov"] ?>
              </option>
              <?php } ?>
            </select>
      ...
      <article class="footer-externa col-xs-12">
        <div class="u-mtop">
          <input type="file" accept="application/pdf" style="display:none" id="diagnostico">
          <label for="diagnostico" class="btn btn-primary btn-raised ripple-effect btn-circle btn-pdf">
            <img src="../assets/iconos/pdf.png" alt="">
          </label>
          <label for="diagnostico" style="cursor:pointer">Suba el informe</label>
        </div>
        <div class="u-mtop">
          <input type="file" accept="application/pdf" style="display:none" id="factura">
          <label for="factura" class="btn btn-warning btn-raised ripple-effect btn-circle btn-pdf">
            <img src="../assets/iconos/pdf.png" alt="">
          </label>
          <label for="factura" style="cursor:pointer">Suba la factura</label>
        </div>

        <div class="col-xs-5 middle">
          <label for="fechaEntrega" class="col-xs-3 control-label">Fecha de entrega</label>
          <div class="col-xs-7">
            <input id="fechaEntrega" class="form-control datepicker" placeholder="Ingrese la fecha de entrega" />
          </div>
        </div>
        <div class="col-xs-4 middle">
          <label for="costoOT" class="col-xs-2 control-label">Costo O.T.</label>
          <div class="col-xs-7">
            <input id="costoOT" class="form-control" placeholder="Ingrese el costo de O.T." />
          </div>
        </div>
      </article>
      ...
      <div class="col-xs-12 center">
        ...
        <button class="btn btn-raised btn-primary none" id="ordenFormGuardar">Guardar</button>
        <button class="btn btn-raised btn-warning none" id="ordenFormTerminar">Terminar</button>
