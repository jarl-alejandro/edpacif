 ...
 <table class="table table-bordered table-default table-striped nomargin"
  ...
  <tbody>
    ...
    <tr>
      <td class=""><?= $count; ?></td>
      <td class=""><?= $rows["eorin_fet_eorin"]; ?></td>
      <td class=""><?= $rows["eequi_det_eequi"]; ?></td>
      <td><?php 
      if ($rows["eorin_est_eorin"] == "asignado" || $rows["eorin_est_eorin"] == "pedido") {
        echo "PENDIENTE";
      }
      if ($rows["eorin_est_eorin"] == "autorizado" || $rows["eorin_est_eorin"] == "visto") {
        echo "MANTENIMIENTO";
      }
      if ($rows["eorin_est_eorin"] == "revisado" || $rows["eorin_est_eorin"] == "finalizado") {
        echo "REALIZADO";
      }
      ?></td>
