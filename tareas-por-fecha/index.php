...
<html lang="es">
<head>
  <title>Reporte de tareas por fecha | Edpacif</title>
...
<body>
      ...
      <div class="contentpanel">
        <div class="row">
          <div class="col-md-9 col-lg-8 dash-left">
            <h2 class="text-center no-margin title">Reporte de tareas por fecha</h2>
  ...
  <div class="panel panel-success col-xs-6" id="panel-orden-fecha">
    <div class="panel-heading">
      <h3 class="panel-title text-center">Tareas por fecha</h3>
    </div>
