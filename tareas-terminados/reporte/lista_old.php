...
class PDF extends FPDF {
  ...
  function Header() {
    ...
    $this->Text(110, 54, 'LISTADO DE TAREAS TERMINADAS FINALIZADO');
    $this->Ln(25);
...
$query = $pdo->query("SELECT * FROM v_tarea WHERE etare_est_etare='finalizado'");
$count = 0;
...
while ($row = $query->fetch()) {
  ...
  $pdf->Cell(100, 6.5, utf8_decode($row['etare_det_etare']), 1, 'C');
