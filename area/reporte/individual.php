...
$query = $pdo->query("SELECT * FROM v_area
...
$header = array('CODIGO', 'AREA GENERAL', 'AREA');

$pdf->TablaColores($header);
$pdf->SetFont('Arial', '',10);
$pdf->SetX(40);

$pdf->Cell(30, 6.5, $row["earea_cod_earea"], 1, 'C');
$pdf->Cell(100, 6.5, utf8_decode($row['earege_det_earege']), 1, 'C');
